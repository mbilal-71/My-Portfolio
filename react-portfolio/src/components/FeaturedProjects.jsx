  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.from('.proj-hdr', {
        ...
        scrollTrigger: { trigger: '.proj-hdr', start: 'top 88%' },
      });
      gsap.from('.proj-card', {
  ...
  return (
    ...
    >
      <div className="section-container">
        ...
        {/* Header */}
        <div className="proj-hdr mb-12 sm:mb-14">
        ...
        {/* 2-col grid */}
        <div className="proj-grid pt-5 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 items-stretch">
          {projects.map((p) => (
            <div
              key={p.id}
